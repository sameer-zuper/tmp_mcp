...
import { makeZuperRequest, apiCredentialsSchema, DEFAULT_ZUPER_API_KEY, DEFAULT_ZUPER_BASE_URL } from "./tools/common";
...
// LEGACY: Keep the old inline tools below for reference during migration
// TODO: Migrate remaining tools to modular structure in tools/ directory
const LEGACY_TOOLS_FOR_MIGRATION = {
